...
public class WateringCanStationButton : MonoBehaviour
{
    ...
    IEnumerator ToggleHeldCanRoutine(SelectEnterEventArgs args)
    {
        ...
        try
        {
            ...
            if (prefab == null)
            {
                Debug.LogWarning("WateringCanStationButton: 未指定 heldCanPrefab，也無法從 Prefab 來源解析。", this);
                yield break;
            }
